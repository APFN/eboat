...
#-> Eboat envs
register(
    id='GazeboOceanEboatEnv-v0',
    entry_point='eboat_gym_gaz.envs:GazeboOceanEboatEnv',
    max_episode_steps=1000000,
)

register(
    id='GazeboOceanEboatEnvD-v0',
    entry_point='eboat_gym_gaz.envs:GazeboOceanEboatEnvD',
    max_episode_steps=1000000,
)
